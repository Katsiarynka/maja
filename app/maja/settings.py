"""
Django settings for maja project.
...
SECRET_KEY = 'django-insecure-al$3=2o(d1j6gnz_q^0+r-789h=w*%o#k&^ea#7^qnin^r+3a&'
...
WSGI_APPLICATION = 'maja.wsgi.application'
